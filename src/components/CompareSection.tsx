    ...
    <section className="compare-section">
      <div className="container">
        ...
        <div className="compare-content-grid">
          <div className="compare-left reveal">
          ...
          <div className="compare-right reveal delay-1">
            <div className="compare-graphic-wrapper">
              <Image
                src="/assets/compare-graphic.webp"
                alt="Comparativa de AIRBAND vs Otras Marcas"
                width={576}
                height={1024}
